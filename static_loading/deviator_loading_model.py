...
class ModelTriaxialDeviatorLoadingSoilTest(ModelTriaxialDeviatorLoading):
    ...
    def set_test_params(self, pre_defined_kr_fgs=None):
        ...
        xc, residual_strength, self.pre_defined_kr_fgs, amplitude_flag = ModelTriaxialDeviatorLoadingSoilTest.define_xc_value_residual_strength(
        ...
        self._draw_params.amplitude_1 = statment[statment.current_test].mechanical_properties.deviations_amplitude[0]#0.04
        self._draw_params.amplitude_2 = statment[statment.current_test].mechanical_properties.deviations_amplitude[1]#0.02
        self._draw_params.amplitude_3 = statment[statment.current_test].mechanical_properties.deviations_amplitude[2]#0.01
    ...
    def define_xc_value_residual_strength(data_phiz, sigma_3, qf, E, pre_defined_kr_fgs=None):
        ...
        return xc, residual_strength, pre_defined_kr_fgs, amplitude
