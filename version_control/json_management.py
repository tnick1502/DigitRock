...
#3. Новый отчет по вибро с 3мя опытами"""})
    ...
    add_data("3.10", """1. Если заполнен уровень Угв< то это влияет на расчет сигма 1 для трехоски
2. Общий виджет запуска
3. Добавлен учет анизатропии при расчете разгрузки
4. Теперь надо вводить номер привоза и он будет в названии папки отчета""")
