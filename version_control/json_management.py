...
if __name__ == "__main__":
    add_data("3.75", """
    1. Точка определения КД теперь находится на медианном значении девиатора в конце испытания
    2. Опыт по вибропрочности перестает отрисосывать круг при соприкосновении с линией разрушения
    3. В протоколе добавлено σ_xg
    3. Уменьшена амплитуда девиаций обьемной деформации
    4. Добавлена возможность предустановки девиаций для всего обьекта
    """)
