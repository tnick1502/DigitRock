...
if __name__ == "__main__":
    add_data("3.74", """
    1. Добавлен опыт определения потенциала разжижения
    2. Добавлен опыт определения снижения модуля деформации при сейсмической нагрузке
    3. Добавлен опыт определения снижения прочностипри сейсмической нагрузке
    """)
