...
#3. Новый отчет по вибро с 3мя опытами"""})
    ...
    add_data("3.49", """
1. Добавлено ограничение 20 на боковое давление
2. Добавлена возможность разрывного масштаба
3. Добавлено автоподжатие обьекта
4. Добавлена возможность вставки qr кода""")
