...
if __name__ == "__main__":
    add_data("3.69", """
    1. Новый вид отчета РК.
    2. Проверка дублирования лабномеров в ведомости.   
    3. Добавлена подсветка красным Kd в результатах при его возрастании. Работает только при возрастающем задании частоты.
    4. Добавлена подсветка красным G0 в результатах при его повторении до целых.
    """)
