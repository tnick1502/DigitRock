...
#3. Новый отчет по вибро с 3мя опытами"""})
    ...
    add_data("3.20", """
1. Добавлен опыт по определению коэффициентов Релея
2. Лучше строятся круги мора
3. Настройки среза 
4. Кнопка выбора вертикальной деформации при сохранении среза
5. Новая зависимость пиков
6. Добавлен модуль по генерации xml
7. Исправления НН и КН
8. Добавлен опыт CF_res
9. Добавлено считывание Kd из журнала excel при генерации опытов
10. Исправлены ошибки обработчика отдельных опытов в КД
""")
