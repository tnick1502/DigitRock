...
if __name__ == "__main__":
    ...
    4. Добавлено избыточное поровое давление для отчета по снижению прочности при динамических нагрузках.
    5. Улучшен модуль усреднения: добавлена подгрузка ведомости с результатами и выдача общей ведомости.
    6. Новая формула Rd для динамики из госта теперь основная.
    7. Исправлена ошибка с чтением привоза
    """)
