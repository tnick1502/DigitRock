...
#3. Новый отчет по вибро с 3мя опытами"""})
    ...
    add_data("3.12", """1. Программа теперь выдает модуль E основным. Добавлена обработка с помощью перетаскивания точек на графике
2. Добавлен новый режим рассчета К0 через формулу Джекки и с учетом переуплотнения
3. Добавлен виджет выбора водонасыщения
4. Исправлен баг с отсутствием сохранения ручной обработки консолидации""")
